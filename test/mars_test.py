...
### Detector Parameters ###
roach_number = 3
detector_number = 571# np.arange(0,668, 1, dtype=int)
...
d = pbt.timing.dirfile_interp('time_val', path_master=master_file, path_roach=roach_file_path, \
...
maps=pbt.mapmaker.mapmaking(final_det, 1., np.zeros(len(final_det)), w, crpix)
